...
// Egyptian Arabic content used when the site is in Arabic mode. Brand names and
// technical standards remain recognisable while every visitor-facing sentence is Arabic.
export const arabicSchoolInfo = {
  ...schoolInfo,
  name: 'مدرسة السويدي الدولية',
  subTitle: 'للتكنولوجيا التطبيقية والبرمجيات',
  tagline: 'أحسن اختيار لمستقبلك في التكنولوجيا',
  founder: {
    ...schoolInfo.founder,
    name: 'م. عماد زكي السويدي',
    role: 'مؤسس مدرسة السويدي للتكنولوجيا التطبيقية ورئيس مجلس إدارة السويدي إليكتروميتر',
    quote: 'فكرة المدرسة كانت بناء منظومة تعليمية بتشجع التفكير النقدي والإتقان التقني والقيادة الشخصية. بنمكّن طلابنا من خبرة هندسية حقيقية من أول يوم عشان يبنوا مستقبل البرمجيات والأنظمة الذكية في مصر والعالم.'
  },
  overview: 'مدرسة السويدي الدولية للتكنولوجيا التطبيقية والبرمجيات اتأسست سنة ٢٠٢٢ بالشراكة مع وزارة التربية والتعليم والتعليم الفني وشركة السويدي إليكتروميتر. المدرسة من أفضل عشر مدارس تكنولوجيا تطبيقية دولية في مصر، وبتقدم مسار تعليمي مزدوج لمدة ٣ سنين يجمع معايير بيرسون بي تيك البريطانية، والمناهج التقنية الدولية، والتدريب العملي داخل الصناعة.',
  contact: {
    ...schoolInfo.contact,
    address: 'مدينة ٦ أكتوبر، محافظة الجيزة، مصر',
    hours: 'الأحد - الخميس: ٨:٠٠ صباحًا - ٣:٣٠ عصرًا'
  },
  stats: [
    { count: 60, suffix: '+', label: 'مشروع تخرج كل سنة', desc: 'حلول عملية بيطورها طلابنا', color: '#DA1B1B' },
    { count: 300, suffix: '+', label: 'طالب مختار', desc: 'أفضل المواهب التقنية من آلاف المتقدمين', color: '#1A1A1A' },
    { count: 2, suffix: '', label: 'تخصص معتمد', desc: 'نظم المعلومات والنظم الإلكترونية', color: '#DA1B1B' },
    { count: 100, suffix: '%', label: 'فرص لتعيين المتفوقين', desc: 'فرص عمل مباشرة في مصانع السويدي إليكتروميتر', color: '#16A34A' }
  ],
  whyUs: [
    'دبلومة مزدوجة: شهادة تقنية معتمدة دوليًا مع البكالوريا التكنولوجية المصرية.',
    'خبرة صناعية حقيقية: تدريب عملي مباشر في مصانع ومعامل السويدي إليكتروميتر.',
    'عدة هندسية مجانية: لابتوب قوي وزي مهني لكل طالب مقبول.',
    'فصول تفاعلية صغيرة: بحد أقصى ٢٥ طالب علشان المتابعة تكون شخصية.',
    'بيئة تقنية بالإنجليزية: المناهج والمشاريع بتتعمل بالإنجليزية عشان فرص عالمية.',
    'مشاريع تخرج سنوية: كل طالب بيصمم ويبني ويدافع عن حل هندسي متكامل.',
    'مركز التطوير المهني: تدريب على السيرة الذاتية ومقابلات وفرص صيفية.',
    'برنامج مساعدة الزملاء: دعم دراسي ونفسي بيقدمه الطلاب لبعضهم.',
    'مركز البرمجة التنافسية: تدريب مع مدربين متميزين لمسابقات البرمجة.',
    'أنشطة متنوعة: رياضة ومعمل تصنيع وفنون رقمية ومسرح.'
  ]
};

const arabicTracksById = {
  software: {
    title: 'علوم الحاسب وبرمجة السوفت وير', shortTitle: 'علوم الحاسب', badge: 'مسار علوم الحاسب',
    description: 'بنجهز الطلاب لتصميم وبناء وإطلاق منصات رقمية قوية، من تطوير الويب والموبايل لقواعد البيانات والسحابة والأمن السيبراني.',
    years: [
      { year: 'السنة الأولى', focus: 'أساسيات البرمجة', modules: ['المنطق وأنظمة التشغيل', 'الاختبار', 'سي بلس بلس', 'بايثون'] },
      { year: 'السنة الثانية', focus: 'هندسة البرمجيات والعمارة', modules: ['حل المشكلات', 'تطبيقات سطح المكتب', 'تطوير الويب'] },
      { year: 'السنة الثالثة', focus: 'أنظمة متقدمة وموبايل وإنترنت الأشياء', modules: ['فلاتر وواجهة ويب', 'وسائط متعددة', 'أنظمة مدمجة', 'إنترنت الأشياء'] }
    ],
    tools: ['سي بلس بلس', 'بايثون', 'أطر تطبيقات سطح المكتب', 'تطوير الويب', 'فلاتر', 'واجهة ويب', 'أنظمة مدمجة', 'إنترنت الأشياء'],
    careerPaths: ['مهندس برمجيات متكامل', 'مطور تطبيقات موبايل', 'مهندس نظم وأنظمة مدمجة', 'مهندس اختبار جودة', 'مطور حلول إنترنت الأشياء']
  },
  integrated: {
    title: 'النظم الإلكترونية والأنظمة المدمجة', shortTitle: 'النظم الإلكترونية', badge: 'مسار الإلكترونيات وإنترنت الأشياء',
    description: 'مسار بيربط بين كود البرمجة والماكينات الحقيقية. الطلاب بيتعلموا المتحكمات والحساسات والأتمتة الصناعية وتصميم الدوائر المطبوعة.',
    years: [
      { year: 'السنة الأولى', focus: 'أساسيات الكهرباء والهاردوير', modules: ['نظرية الدوائر والإلكترونيات', 'برمجة الأنظمة المدمجة', 'المنطق الرقمي والمعالجات', 'الحساسات ومعالجة الإشارات'] },
      { year: 'السنة الثانية', focus: 'المتحكمات والاتصالات', modules: ['برمجة المتحكمات', 'بروتوكولات إنترنت الأشياء', 'تصميم الدوائر واللحام', 'أنظمة التشغيل اللحظية'] },
      { year: 'السنة الثالثة', focus: 'الأتمتة الصناعية والشبكات الذكية', modules: ['القياس الذكي', 'أنظمة التحكم الصناعية', 'مشروع هاردوير سنوي', 'تدريب في مصانع السويدي'] }
    ],
    tools: ['لغة سي للأنظمة المدمجة', 'إي إس بي ٣٢', 'إس تي إم ٣٢', 'كي كاد', 'إم كيو تي تي', 'أردوينو', 'راسم ذبذبات', 'محللات منطقية'],
    careerPaths: ['مهندس برمجيات مدمجة', 'مطور أنظمة إنترنت الأشياء', 'متخصص شبكات ذكية', 'متخصص أتمتة هاردوير', 'مهندس تكامل روبوتات']
  }
};
export const arabicSpecializationsDetailed = specializationsDetailed.map((track) => ({ ...track, ...arabicTracksById[track.id] }));

const arabicFacilitiesById = {
  fablab: { category: 'معامل هندسية', title: 'معمل التصنيع الرقمي المتطور', description: 'معمل تصنيع رقمي مجهز بطابعات ثلاثية الأبعاد وقواطع ليزر وماكينات دوائر مطبوعة ومحطات لحام إلكترونيات.', specs: ['١٢ طابعة ثلاثية الأبعاد', 'قواطع ليزر', 'محطات لحام وصيانة', 'راسمات ذبذبات ومحللات طيف'], access: 'مفتوح يوميًا لفرق مشاريع التخرج ومشاريع الطلاب' },
  art: { category: 'الفنون الإبداعية', title: 'استوديو الفنون والتصميم', description: 'مساحة فنية مخصصة لتعلم الرسم الرقمي وتصميم واجهات المستخدم ونظرية الألوان والرسم وإقامة المعارض.', specs: ['ألواح رسم رقمية', 'حوامل وطاولات رسم', 'خامات نحت', 'حائط للمعارض'], access: 'حصص أسبوعية ومعرض فني سنوي' },
  music: { category: 'الفنون الإبداعية', title: 'أكاديمية الموسيقى', description: 'بننمي الانضباط السمعي والأداء الجماعي من خلال الآلات والتدريب الصوتي ونظرية الموسيقى والحفلات.', specs: ['بيانو وكيبورد', 'جيتارات', 'إيقاعات وكمان', 'استوديو عازل للصوت'], access: 'دروس موسيقية وبروفات أوركسترا المدرسة' },
  drama: { category: 'الفنون الأدائية', title: 'استوديو المسرح والدراما', description: 'بنساعد الطلاب يكتسبوا ثقة في التحدث أمام الجمهور والحكي والتمثيل وكتابة النصوص وتقديم المحتوى.', specs: ['مسرح وإضاءة', 'ميكروفونات لاسلكية', 'كاميرات استوديو', 'غرفة كتابة نصوص'], access: 'ورش كل أسبوعين وعرض مسرحي سنوي' },
  sports: { category: 'الرياضة', title: 'المركز الرياضي والملاعب', description: 'بنقوي اللياقة والروح الجماعية من خلال دوري كرة القدم والسلة والطائرة وتنس الطاولة.', specs: ['ملعب كرة قدم', 'صالة متعددة الرياضات', 'طاولات تنس', 'مدربين متخصصين'], access: 'تربية رياضية وتدريب للبطولات' },
  cdc: { category: 'التطوير المهني والقيادة', title: 'مركز التطوير المهني', description: 'بنجهز الطلاب لفرص تقنية قوية من خلال كتابة السيرة الذاتية والمقابلات التجريبية والتدريب الصناعي.', specs: ['إرشاد مهني فردي', 'غرفة محاكاة مقابلات', 'معارض وظائف', 'شبكة خريجين'], access: 'دعم مخصص لطلاب السنة الثانية والثالثة' },
  php: { category: 'دعم الطلاب', title: 'برنامج مساعدة الزملاء', description: 'مبادرة طلابية للدعم الدراسي والاجتماعي والنفسي بتقوي التعاطف وروح المجتمع وتسهّل الاندماج.', specs: ['مجموعات مذاكرة', 'دوائر دعم نفسي', 'استقبال الطلاب الجدد', 'سفراء ضد التنمر'], access: 'متاح لكل الطلاب طوال العام الدراسي' },
  entrepreneurship: { category: 'التطوير المهني والقيادة', title: 'مسار ريادة الأعمال لثلاث سنين', description: 'برنامج حاضنة أعمال بيوجه فرق مشاريع التخرج لتسجيل براءات واختيار نماذج أعمال وعرض الأفكار على المستثمرين.', specs: ['تدريب نموذج العمل', 'أيام عرض للمستثمرين', 'إرشاد ملكية فكرية', 'تمويل مبدئي'], access: 'مدمج في الرحلة التعليمية لثلاث سنين' }
};
export const arabicFacilitiesDetailed = facilitiesDetailed.map((item) => ({ ...item, ...arabicFacilitiesById[item.id] }));

export const arabicSpecialMoments = [
  { ...specialMoments[0], title: 'زيارة رسمية للسيدة الأولى الأمريكية الدكتورة جيل بايدن', category: 'ضيف مميز', quote: 'مهارات هؤلاء الطلاب والتزامهم بتعكس الإمكانات الكبيرة للشباب المصري وقوة الشراكات التعليمية الدولية.', description: 'خلال زيارتها الرسمية لمصر، زارت الدكتورة جيل بايدن مدرسة السويدي الدولية للتكنولوجيا التطبيقية والبرمجيات، وشاهدت نماذج الطلاب في البرمجيات وإنترنت الأشياء وأشادت بشراكة تنمية القوى العاملة مع السويدي.', highlights: ['علاقات دولية', 'عرض نماذج الطلاب', 'شراكة مع يو إس إيد', 'تمكين الشباب'] },
  { ...specialMoments[1], title: 'انطلاق بطولة السويدي لحل المشكلات البرمجية', category: 'بطولة', quote: 'طلاب السويدي أثبتوا قدرة على التفكير الحاسوبي بمستوى طلاب علوم الحاسب في الجامعة.', description: 'انطلقت النسخة الأولى من مسابقة السويدي لحل المشكلات بحضور المدرب محمد عبد الوهاب، وشارك أكثر من ٤٠ فريقًا طلابيًا في حل تحديات خوارزمية متقدمة.', highlights: ['حضور مدرب عالمي', 'تميز خوارزمي', 'تقدير عالمي', 'برمجة تنافسية'] }
];
